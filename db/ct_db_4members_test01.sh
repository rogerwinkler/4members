...
/Library/PostgreSQL/10/bin/psql --username=postgres --no-password --host=localhost --port=5432 --file=ct_db_4members_test01.sql
#
#
#
#
...
/Library/PostgreSQL/10/bin/psql --username=4members --no-password --host=localhost --port=5432 --dbname=4members_test01 --file=master.sql
