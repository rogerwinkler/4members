...
const debug          = require('debug')('4members.BusinessUnitsController')
const debugGetAll    = require('debug')('4members.BusinessUnitsController.getAll')
const debugGet       = require('debug')('4members.BusinessUnitsController.get')
const debugInsert    = require('debug')('4members.BusinessUnitsController.insert')
const debugUpdate    = require('debug')('4members.BusinessUnitsController.update')
const debugDelete    = require('debug')('4members.BusinessUnitsController.delete')
const debugDeleteAll = require('debug')('4members.BusinessUnitsController.deleteAll')
...
module.exports = {
  ...
  async getAll (req, res) {
    ...
    var retObj = {}
     // select
    const result = await BusinessUnitsHelpers.getAll()
  ...
  async get (req, res) {
    ...
    const result = await BusinessUnitsHelpers.get(req.params.id)
    if (result.status==='error') {
  ...
  async insert (req, res) {
    ...
    // insert
    const result2 = await BusinessUnitsHelpers.insert(businessUnit)
  ...
  async update (req, res) {
    ...
    // update
    const businessUnit = new BusinessUnit(req.params.id, req.body.name, req.body.dsc, req.body.active)
    const result2 = await BusinessUnitsHelpers.update(businessUnit)
    if (result2.status == 'error') {
  ...
  async delete (req, res) {
    ...
    const result = await BusinessUnitsHelpers.delete(req.params.id)
    if (result.status == 'error') {
